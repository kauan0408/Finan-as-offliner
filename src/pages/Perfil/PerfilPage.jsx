...
export default function PerfilPage() {
  ...
  function executarApagarMarcadas() {
  ...
  function executarApagarTudo() {
    ...
    /*
      Quando há data selecionada, este botão apaga somente registros
      com data: Finanças, Reserva e Acertos. Perfil e Cartões ficam seguros.
    */
